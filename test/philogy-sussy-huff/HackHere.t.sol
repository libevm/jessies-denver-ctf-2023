...
import {IChallenge} from "../../src/philogy-sussy-huff/IChallenge.sol";
...
contract HackHere is Test {
    ...
    function setUp() public {
        ...
        challenge = IChallenge(deployer.deploy("./src/philogy-sussy-huff/Challenge.huff", challengeOverrides, 0));
